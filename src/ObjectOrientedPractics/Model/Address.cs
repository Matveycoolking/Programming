...
namespace ObjectOrientedPractics.Model
{
    ...
    public class Address
    {
        ...
        /// </summary>
        /// <returns>Строка в формате: "Индекс, Страна, г. Город, ул. Улица, д. Дом, кв. Квартира"</returns>
        public override string ToString()
        {
            string apartmentPart = string.IsNullOrEmpty(Apartment) ? "" : $", кв. {Apartment}";
            return $"{Index}, {Country}, г. {City}, ул. {Street}, д. {Building}{apartmentPart}";
        }
    }
}
